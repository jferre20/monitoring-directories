...
then
   ...
   curl -X POST https://controller.jferre.local/api/v2/job_templates/9/launch/ -H "Content-Type: application/json" -H "Authorization: Bearer YOUR_TOKEN_HERE" --data "{\"extra_vars\": {\"path_file\": $PATHS } }"
